...
// TEMPORARY HIDDEN GYM DONT USE THIS 
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group([
        ...
        Route::prefix('admin')->group(function () {
            ...
            Route::get('/members/{member}/latest-start-date', [MemberController::class, 'getLatestStartDate'])->name('members.latest-start-date');
            ...
            // export database to excel route
