/**
 * to use Jsqr@ ; link it using
 *
 *  <script src="{{ asset('js/jsqr.js') }}" defer></script>      - currently used at layout/dash
 * OR
    ...
    return (function (o) {
                    ...
                    return (
                        ...
                        (o.prototype.addOrSubtract = function (e) {
                            ...
                            for (n = d; n < s.length; n++)
                                a[n] = t.addOrSubtractGF(c[n - d], s[n]);
                ...
                for (var r = 0, t = e; r < t.length; r++) {
                    ...
                    if (l)
                        return {
                            ...
                            chunks: l.chunks,
                            location: {
                                topRightCorner: n.mappingFunction(
                                    d.dimension,
                                    0
                                ),
                                topLeftCorner: n.mappingFunction(0, 0),
                                bottomRightCorner: n.mappingFunction(
                                    d.dimension,
                                    d.dimension
                                ),
                                bottomLeftCorner: n.mappingFunction(
                                    0,
                                    d.dimension
                                ),
        ...
        function (o, e, r) {
            ...
            e.binarize = function (o, e, r, a) {
                ...
                for (var d = new s(e, r), n = 0; n < e; n++)
                    for (var l = 0; l < r; l++) {
                        var i = o[4 * (l * e + n) + 0],
                            B = o[4 * (l * e + n) + 1],
                            k = o[4 * (l * e + n) + 2];
                        d.set(n, l, 0.2126 * i + 0.7152 * B + 0.0722 * k);
                    }
                for (
                    var u = Math.ceil(e / 8),
                        C = Math.ceil(r / 8),
                ...
                var g = t.BitMatrix.createEmpty(e, r),
                    x = null;
                for (
                    a && (x = t.BitMatrix.createEmpty(e, r)), f = 0;
                    f < C;
                    f++
                )
                    for (w = 0; w < u; w++) {
                ...
                for (
                    var c = i[r.dataMask],
                        ...
                        a = (function (o) {
                            ...
                            for (
                                var c = 0, s = o.alignmentPatternCenters;
                                c < s.length;
                                c++
                            )
                                for (
            ...
            function l(o, e) {
                for (
                    ...
                    var a = o.readBits(11),
                        d = Math.floor(a / 45),
                        l = a % 45;
                    r.push(n[d].charCodeAt(0), n[l].charCodeAt(0)),
                        (t += n[d] + n[l]),
                        (s -= 2);
                }
                if (1 === s) {
                        ...
                        for (
                            ...
                            for (
                                ...
                                (B = B.addOrSubtract(o.buildMonomial(C, m))),
                                    (a = a.addOrSubtract(
                                        s.multiplyByMonomial(C, m)
                                    ));
                            }
                            if (
                                ((n = B.multiplyPoly(d).addOrSubtract(i)),
                                a.degree() >= s.degree())
                            )
                                return null;
                        }
        ...
        function (o, e, r) {
            ...
            function a(o, e, r, t) {
                var c,
                    a = e.y - o.y,
                    d = e.x - o.x,
                    n = s(o, e, r, Math.ceil(t / 2)),
                    l = s(o, { x: o.x - d, y: o.y - a }, r, Math.ceil(t / 2)),
                    i = n.shift() + l.shift() - 1;
            ...
            function i(o, e, r, s, d) {
                ...
                try {
                    (l = (function (o, e, r, s) {
                        ...
                        var n = Math.round(t(o, e) / d),
                            l = Math.round(t(o, r) / d),
                            i = Math.floor((n + l) / 2) + 7;
                        switch (i % 4) {
                            case 0:
                                i++;
                                break;
