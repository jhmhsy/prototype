                                        ...
                                        <div class="p-2">
                                            <div class="relative w-full overflow-auto">
                                                <table class="w-full text-sm mb-3">
                                                    <thead class="text-black dark:text-white">
                                                        <tr
                                                            class="border-b dark:border-white/50 transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted justify-evenly">
                                                            <th class="h-12 px-4 text-left align-middle">Owner</th>
                                                            <th class="h-12 px-4 text-left align-middle">Service Type
                                                            </th>
                                                            <th class="h-12 px-4 text-left align-middle">Status</th>
                                                            <th class="h-12 px-4 text-left align-middle">Amount</th>
                                                            <th class="h-12 px-4 text-left align-middle">Duration</th>
                                                    ...
                                                    <td class="whitespace-nowrap px-4 text-left">
                                                        {{ $service->member->name}}</td>
                                                    <td class="whitespace-nowrap px-4 text-left">
                                                        {{ $service->service_type }}</td>
                                                    <td class="whitespace-nowrap px-4 text-left">{{ $service->status }}
                                                    </td>
                                                    <td class="whitespace-nowrap px-4 text-left">{{ $service->amount }}
                                                    </td>
                                                    <td class="whitespace-nowrap px-4 text-left">
                                                        {{ $service->start_date }} -
                                                        {{ $service->due_date }}
                                                    ...
                                                    <td class="whitespace-nowrap px-4 text-left text-amber-700">Pending
                                                        Deletion</td>
                                                        ...
                                                        <div class="action-dropdown flex items-center justify-center">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="py-1">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('services.approve', $service->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <button type="submit"
                                                                    ...
                                                                    <form
                                                                        action="{{ route('services.disapprove', $service->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <button type="submit"
