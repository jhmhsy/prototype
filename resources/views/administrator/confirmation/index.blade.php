...
<x-dash-layout title="Roles">
    <div class=" mx-1 md:mx-3 lg:mx-6 py-8 px-4 sm:px-6 lg:px-8 text:black dark:text-gray-300 dark:bg-peak-3 border dark:border-white/10 rounded-lg"
                    ...
                    <div class="relative w-full overflow-auto">
                        <table class="w-full text-sm mb-3">
                            <thead class="text-black  dark:text-gray-500">
                                <tr
                                    class="border-b dark:border-white/10 transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
