<div style="display:none;" x-show="lockerendWarning" class="fixed inset-0 bg-black opacity-50 z-40"
    @click="lockerendWarning = false"></div>

<div style="display:none;" x-show="lockerendWarning" x-transition:enter="transition ease-out duration-300"
    ...
    <div class="bg-white dark:bg-peak_2 p-6 rounded-lg shadow-xl max-w-md w-full mx-4"
        @click.away="lockerendWarning = false">
        <h3 class="text-xl font-bold mb-4">Important</h3>
        <p class="mb-4 text-gray-500">The locker is currently ongoing. Would you like to proceed with ending it?</p>
        <div class="flex justify-end space-x-4">
            <div>
                <button @click="lockerendWarning = false, openservices = true"
