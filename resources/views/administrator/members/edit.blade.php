...
<div style="display: none;"
    class="modal fixed w-full md:w-[60%] lg:w-[35%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 p-4"
                        ...
                        <div class="col-md-6">
                            <select name="membership_type" id="membership_type"
                                ...
                                <option value="Regular" {{ old('membership_type', $member->membership_type) == 'Regular' ? 'selected' : '' }}>
                                    Regular</option>
                                <option value="Manual" {{ old('membership_type', $member->membership_type) == 'Manual' ? 'selected' : '' }}>
                                    Manual</option>
                            </select>
