                            ...
                            <div class="mt-2 px-7 py-3">
                                <div class="flex gap-5 w-full">
                                    ...
                                    <div class="text-sm text-left text-gray-500 flex flex-col">
                                        ...
                                        <p>Phone: <span
                                                class="text-black dark:text-white">{{ $member->phone ?? 'N/A' }}</span><br>
                                        </p>
                                        <p>Facebook: <span
                                                class="text-black dark:text-white">{{ $member->fb ?? 'N/A' }}</span><br>
                                        </p>
                                        <p>Email: <span
                                                class="text-black dark:text-white">{{ $member->email }}</span><br></p>
                                        <p>User ID: <span
                                                class="text-black dark:text-white">{{ $member->user_identifier }}</span>
                                        </p>
