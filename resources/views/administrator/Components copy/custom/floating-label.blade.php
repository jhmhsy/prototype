@props(['value'])
@php
    $defaults = 'absolute text-sm text-shade_9 dark:text-shade_9 duration-300 transform -translate-y-4 scale-75 top-2
    origin-[0] bg-tint_3 dark:bg-tint_7 px-2 peer-focus:px-2 peer-focus:text-shade_9 peer-focus:dark:tint_1
