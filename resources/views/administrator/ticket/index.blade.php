                        ...
                        <tbody class="[&amp;_tr:last-child]:border-0">
                            ...
                            <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                <td class="px-4 align-middle [&amp;:has([role=checkbox])]:pr-0 font-medium">
                                    {{ $ticket->name }}</td>
                                <td class="px-4 align-middle [&amp;:has([role=checkbox])]:pr-0">{{ $ticket->email }}
                                </td>
                                <td class="px-4 align-middle [&amp;:has([role=checkbox])]:pr-0">{{ $ticket->quantity }}
                                </td>
                                <td class="px-4 align-middle [&amp;:has([role=checkbox])]:pr-0">{{ $ticket->status }}
                                </td>
