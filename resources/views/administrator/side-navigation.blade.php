...
<aside id="separator-sidebar"
    ...
    <div class="h-screen px-3 py-4 overflow-y-auto flex flex-col justify-between bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('administrator.overview') }}" class="flex items-center p-2 rounded-lg group dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700
            {{ request()->routeIs('administrator.overview') ? 'bg-gray-300' : 'text-gray-500 hover:bg-gray-200' }}">
                    ...
                    <span class="ms-3 text-md">Overview</span>
                </a>
            </li>
            <li>
                <a href="{{ route('administrator.reservations') }}"
                    class="flex items-center p-2 rounded-lg group dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700
            {{ request()->routeIs('administrator.reservations') ? 'bg-gray-300' : 'text-gray-500 hover:bg-gray-200' }}">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap text-md">Reservation</span>
                    <span
                        class="inline-flex items-center justify-center px-2 ms-3 text-xs font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span>
                </a>
            </li>
            <li>
                <a href="{{ route('administrator.equipments') }}" class="flex items-center p-2 rounded-lg group dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700
            {{ request()->routeIs('administrator.equipments') ? 'bg-gray-300' : 'text-gray-500 hover:bg-gray-200' }}">
                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        transform="rotate(0)">
                        <path d="M20.3873 7.1575L11.9999 12L3.60913 7.14978" stroke="#000000" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M12 12V21" stroke="#000000" stroke-width="2" stroke-linecap="round"
                        ...
                        <path d="M8.5 4.5L16 9" stroke="#000000" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"></path>

                    </svg>


                    <span class="flex-1 ms-3 whitespace-nowrap text-md">Equipments</span>
                </a>
            </li>
            <li>
                <a href="{{ route('administrator.events') }}" class="flex items-center p-2 rounded-lg group dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700
            {{ request()->routeIs('administrator.events') ? 'bg-gray-300' : 'text-gray-500 hover:bg-gray-200' }}">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap text-md">Events</span>
                </a>
            </li>
            <li>
                <a href="{{ route('administrator.tickets') }}" class="flex items-center p-2 rounded-lg group dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700
            {{ request()->routeIs('administrator.tickets') ? 'bg-gray-300' : 'text-gray-500 hover:bg-gray-200' }}">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap text-md">Tickets</span>
                </a>
            </li>
            <li>
                <a href="{{ route('administrator.users') }}" class="flex items-center p-2 rounded-lg group dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700
            {{ request()->routeIs('administrator.users') ? 'bg-gray-300' : 'text-gray-500 hover:bg-gray-200' }}">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <li>
                <a href="{{ route('administrator.roles') }}" class="flex items-center p-2 rounded-lg group dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700
            {{ request()->routeIs('administrator.roles') ? 'bg-gray-300' : 'text-gray-500 hover:bg-gray-200' }}">
                    <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
            ...
            <li>
                <a href="{{ route('administrator.feedback') }}" class="flex items-center p-2 rounded-lg group dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700
       {{ request()->routeIs('administrator.feedback') ? 'bg-gray-300' : 'text-gray-500 hover:bg-gray-200' }}">
                    <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M7 8v8a5 5 0 1 0 10 0V6.5a3.5 3.5 0 1 0-7 0V15a2 2 0 0 0 4 0V8" />
                    </svg>
                    <span class="flex-1 ms-3 whitespace-nowrap text-md">Feedback</span>
                </a>
            </li>


            <li>
                <a href="{{ route('administrator.help') }}" class="flex items-center p-2 rounded-lg group dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700
       {{ request()->routeIs('administrator.help') ? 'bg-gray-300' : 'text-gray-500 hover:bg-gray-200' }}">
                    <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        viewBox="0 0 24 24">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap text-md">Help</span>
                </a>
            </li>
        </ul>
        ...
        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
                <a href="#"
                    ...
                    <span class="ms-3 text-md">Settings</span>
                </a>
            </li>
            <li>
                <a href="#"
                    ...
                    <span class="ms-2 text-md">Logout</span>
                </a>
            </li>
        </ul>
    </div>
