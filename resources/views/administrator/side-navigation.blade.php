    ...
    <aside id="separator-sidebar"
        ...
        <div class="h-screen px-3 py-4 overflow-y-auto flex flex-col justify-between bg-gray-50 dark:bg-peak_2">
            ...
            <ul class="space-y-2 overflow-y-auto font-medium">
                ...
                <!--︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼ MEMBER CONTROL ︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼  -->
                @canany(['member-create', 'member-list', 'member-view', 'member-services', 'member-edit',
                    'member-membership-renew', 'member-delete', 'subscription-create', 'subscription-extend',
                    'subscription-end', 'locker-create', 'locker-extend', 'locker-end', 'treadmill-create',
                    'treadmill-extend', 'treadmill-end', 'checkin-log-list'])

                    <li x-data="{ open: {{ request()->routeIs('members.create') || request()->routeIs('members.index') || request()->routeIs('checkin.history') ? 'true' : 'false' }} }">
                        <button type="button"
                        ...
                        <ul style="display:none;" x-show="open" x-transition class="py-2 space-y-2">
                            ...
                            @canany(['member-list', 'member-view', 'member-services', 'member-edit',
                                'member-membership-renew', 'member-delete', 'subscription-extend', 'subscription-end',
                                'locker-extend', 'locker-end', 'treadmill-extend', 'treadmill-end'])
                                <li>
                ...
                @can('productsales-list')
                    <li>
                        <a href="{{ route('administrator.productsales') }}"
                            class="flex items-center p-2 rounded-lg group  {{ request()->routeIs('administrator.productsales') ? 'bg-gray-300 text-black dark:bg-gray-700 dark:text-white' : 'text-gray-500 dark:text-gray-500  hover:bg-gray-300 hover:text-black dark:hover:bg-gray-700 dark:hover:text-white' }} transition-colors duration-300">
                            <!-- Added transition classes -->
                ...
                @canany(['feedback-list'])
                    <li>
                        <a href="{{ route('administrator.feedback') }}"
                            class="flex items-center p-2 rounded-lg group  {{ request()->routeIs('administrator.feedback') ? 'bg-gray-300 text-black dark:bg-gray-700 dark:text-white' : 'text-gray-500 dark:text-gray-500 hover:bg-gray-300 hover:text-black dark:hover:bg-gray-700 dark:hover:text-white' }} transition-colors duration-300">
                            <!-- Added transition classes -->
