    ...
    <aside id="separator-sidebar"
        ...
        <div class="h-screen px-3 py-4 overflow-y-auto flex flex-col justify-between bg-gray-50 dark:bg-peak_2">
            ...
            <ul class="space-y-2 overflow-y-auto font-medium">
                ...
                <!--︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼ MEMBER CONTROL ︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼  -->
                @canany(['member-create', 'member-list', 'member-edit', 'member-membership-renew',
                    'subscription-create', 'subscription-extend', 'subscription-end', 'locker-create', 'locker-extend',
                    'locker-end', 'treadmill-create', 'treadmill-extend', 'treadmill-end'])
                    ...
                    <li x-data="{ open: {{ request()->routeIs('members.create') || request()->routeIs('members.index') ? 'true' : 'false' }} }">
                        ...
                        <ul style="display:none;" x-show="open" x-transition class="py-2 space-y-2">
                            ...
                            @canany(['member-list', 'member-edit', 'member-membership-renew', 'subscription-extend',
                                'subscription-end', 'locker-extend', 'locker-end', 'treadmill-extend', 'treadmill-end'])
                                <li>
                            ...
                            @canany(['member-create', 'subscription-create', 'locker-create', 'treadmill-create'])
                                <li>
                                    <a href="{{ route('members.create') }}"
                                        class="flex items-center w-full p-2 text-gray-500 dark:text-gray-500 hover:bg-gray-300 hover:text-black dark:hover:bg-gray-700 dark:hover:text-white {{ request()->routeIs('members.create') ? 'bg-gray-300 text-textblack dark:bg-gray-700 dark:text-white ' : '' }} text-sm pl-11 transition-colors duration-300 rounded-lg group">
                                        Add Member</a>
                                </li>
                            @endcanany
...
{{ request()->routeIs('ticket.transaction') ? 'bg-gray-300 text-textblack dark:bg-gray-700 dark:text-white text-sm' : 'text-sm' }} transition-colors duration-300 pl-11 rounded-lg group">
   ...
   hover:bg-gray-300 hover:text-black 
   dark:hover:bg-gray-700 dark:hover:text-white 
   {{ request()->routeIs('administrator') ? 'bg-gray-300 text-textblack dark:bg-gray-700 dark:text-white' : '' }}
          transition-colors duration-300">
