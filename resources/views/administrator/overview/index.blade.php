<x-dash-layout>
    <div
        class="text-shade_9 dark:text-tint_1 border-shade_6/50 dark:border-white/5 flex flex-col space-y-3 overflow-auto">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 ">
            ...
            <div
                class="border dark:border-white/30 border-shade_6/50  rounded-lg px-4 py-5 flex space-x-2 items-center">
                <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                    class="text-main dark:text-tint_8" fill="currentColor">
            ...
            <div class="border dark:border-white/30 border-shade_6/50 rounded-lg px-4 py-5 flex space-x-2 items-center">
                <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg" class="text-main dark:text-tint_8"
        ...
        <div class="grid md:grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="rounded-lg border dark:border-white/30 border-shade_6/50 dark:border border-shade_6/50-white/5 bg-card text-card-foreground shadow-sm"
                data-v0-t="card">
                <div class="flex flex-col space-y-1.5 p-6">
            ...
            <div class="rounded-lg border  border-shade_6/50 dark:border dark:border-white/30 border-shade_6/50-white/5 bg-card text-card-foreground shadow-sm"
                data-v0-t="card">
                <div class="flex flex-col space-y-1.5 p-6">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="bg-muted rounded-full w-12 h-12 flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    stroke-linejoin="round" class="w-6 h-6 text-muted-foreground">
                                    <path d="M8 2v4"></path>
                                    <path d="M16 2v4"></path>
