<<<<<<< HEAD
<x-dash-layout>
    <div class="text-night dark:text-gray-200 flex flex-col space-y-3 overflow-auto">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 dark:text-gray-200">
            <div
                class="bg-white dark:bg-peak-2 rounded-lg px-4 py-5 flex space-x-2 items-center border border-black/40 dark:border-white/40">
                <svg width="50" height="50" xmlns="http://www.w3.org/2000/svg"
                    class="text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 640 512">
                    <path
                ...
                <div>
                    <h1 class="text-sm dark:text-gray-200">Total Members</h1>
                    <p class="text-2xl font-bold dark:text-gray-100">{{ $members }}</p>
                </div>
            </div>
            <div
                class="bg-white dark:bg-peak-2 rounded-lg px-4 py-5 flex space-x-2 items-center border border-black/40 dark:border-white/40">
                ...
                <div>
                    <h1 class="text-sm dark:text-gray-200">Monthly Subscriptions</h1>
                    <p class="text-xl font-bold dark:text-gray-100">{{ $subscription }}</p>
                </div>
            </div>
            <div
                class="bg-white dark:bg-peak-2 rounded-lg px-4 py-5 flex space-x-2 items-center border border-black/40 dark:border-white/40">
                ...
                <div>
                    <h1 class="text-sm dark:text-gray-200">Total Reservations</h1>
                    <p class="text-xl font-bold dark:text-gray-100">{{ $totalBooking }}</p>
                </div>
            </div>
            <div
                class="bg-white dark:bg-peak-2 rounded-lg px-4 py-5 flex space-x-2 items-center border border-black/40 dark:border-white/40">
                ...
                <div>
                    <h1 class="text-sm dark:text-gray-200">Positive Feedbacks</h1>
                    <p class="text-xl font-bold dark:text-gray-100">{{ $totalFeedbackRating }}</p>
                </div>
            </div>
        </div>
...
<<<<<<< HEAD
                    ...
                    const monthlyData = {
                        ...
                        datasets: [{
                            ...
                            borderWidth: 1,
                            barPercentage: 0.9 // Slim the bars slightly
                        }]
                    };
