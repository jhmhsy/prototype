    ...
    <x-dash-layout>
        <div class="text-night dark:text-white flex flex-col space-y-3 overflow-auto">
            ...
            <div class="grid md:grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="border border-gray-300 dark:border-none rounded-lg bg-white dark:bg-peak-2 shadow-sm">
                ...
                <div class="grid grid-cols-1 gap-5">
                    <div
                        class="w-full h-full bg-white dark:bg-peak-2 border border-gray-300 dark:border-none rounded-lg p-5">
