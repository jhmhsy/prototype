...
<x-dash-layout title="Users">
    <div class="mx-1 md:mx-3 lg:mx-5 flex flex-col rounded-lg border shadow-sm p-6 border-white/10 dark:border-white/5 dark:bg-peak-3"
                                        ...
                                        <div
                                            ...
                                            <div class="py-1">
                                                ...
                                                <form method="POST" action="{{ route('users.destroy', $user->id) }}"
                                                    ...
                                                    @if ($user->getRoleNames()->first() == 'SuperAdmin')
                                                    <button
                                                        class="w-full group flex items-center px-4 py-2 text-sm text-gray-400 cursor-not-allowed"
                                                        disabled>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                        ...
                                                        Delete &nbsp; <span
                                                            class="text-xs text-red-600">Unavailable</span>
                                                    </button>
                                                    @else
                                                    <button
