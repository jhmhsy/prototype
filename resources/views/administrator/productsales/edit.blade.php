...
<div style="display: none;"
    ...
    x-show="Editmodal === {{$product->id}}" @click.away="Editmodal = false"
        ...
        <div
            ...
            <div class=" mt-50 p-4">
                ...
                <div class="p-6 dark:text-white">
                    ...
                    <form action="{{ route('productsales.update', $product->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('name', $product->name) }}" placeholder="Enter equipment name" />
                            </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea
                                ...
                                name="details" id="details" required maxlength="300"
                                placeholder="Enter equipment details"
                                rows="4">{{ old('details', $product->details) }}</textarea>
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-500" for="name">
                                Price
                            ...
                            <input
                                ...
                                value="{{ old('price', $product->price) }}" placeholder="Enter equipment name" />
                        </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input class="dark:bg-peak_1 flex h-10 w-full rounded-md border dark:border-none  px-3 py-2 text-sm"
                        ...
                        value="{{ old('quantity', $product->quantity) }}" placeholder="Enter equipment name" />
                </div>
