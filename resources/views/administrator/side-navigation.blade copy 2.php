<div>
    <aside id="separator-sidebar"
        class="relative hidden top-0 left-0 z-40 w-80 h-screen transition-transform -translate-x-full sm:translate-x-0 sm:block "
        aria-label="Sidebar">
...
{{ request()->routeIs('administrator.scan') ? 'bg-gray-300 text-textblack dark:bg-gray-700 dark:text-white text-sm' : 'text-sm' }} transition-colors duration-300 pl-11 rounded-lg group">
   ...
   {{ request()->routeIs('administrator.roles') ? 'bg-gray-300 text-textblack dark:bg-gray-700 dark:text-white' : '' }}
          ...
          transition-colors duration-300">
                ...
                <!--︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼ HELP ︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼  -->
                <li>
                    <a href="{{ route('administrator.help') }}" class="flex items-center p-2 rounded-lg group 
   text-gray-500 dark:text-gray-500 
   hover:bg-gray-300 hover:text-black 
   dark:hover:bg-gray-700 dark:hover:text-white 
