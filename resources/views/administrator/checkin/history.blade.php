...
<x-dash-layout title="Checkin Logs">
    <div class="container dark:bg-peak-3 p-5 mx-auto rounded-lg">
        ...
        <div class="flex flex-col md:flex-row gap-3 md:gap-5 mb-4">
            ...
            <form action="{{ route('checkin.history') }}" method="GET" class="w-full sm:w-[80%] ">
                <div class="relative">
                    <button type="submit"
        ...
        <div class="overflow-x-auto rounded-md">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-white/30">
                ...
                <tbody class="bg-white dark:bg-peak_2 divide-y divide-gray-900 dark:text-white">
                    @if ($checkins->isEmpty())
                    <td colspan="8" class="text-center p-3  text-gray-500 mt-4">No check-in logs available at
                        this time.
                    </td>
                    @else
