...
<ul class="space-y-2 font-medium text-shade_9 dark:text-tint_1">
    <!--------------------------- DASHBOARD BUTTON --------------------------------->
    <li>
        <x-custom.sidenav-button href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
    ...
    <li>
        ...
        <x-custom.sidenav-button href="{{ route('events') }}" :active="request()->routeIs('events')">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5">
                <path d="M8 2v4"></path>
                <path d="M16 2v4"></path>
    ...
    <li>
        <x-custom.sidenav-button href="{{ route('users.index') }}" :active="request()->routeIs('users.*')">
            ...
            <span class="sm:hidden flex-1 ms-3 whitespace-nowrap pr-20">Manage Users</span>
        </x-custom.sidenav-button>
    </li>
    <!--------------------------- Permissions --------------------------------->
    <li>
        <x-custom.sidenav-button href="{{ route('roles.index') }}" :active="request()->routeIs('roles.*')">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-fingerprint"
                viewBox="0 0 16 16">
                <path
