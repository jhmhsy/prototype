<div>
   ...
   {{ request()->routeIs('administrator.overview') ? 'bg-gray-300 text-textblack dark:bg-gray-700 dark:text-white' : '' }}">
                ...
                <!--︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼ RESERVATION ︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼︼  -->
                <li x-data="{ open: {{ request()->routeIs('administrator.overview') 
...
text-gray-500 dark:text-gray-500 
hover:bg-gray-300 hover:text-black 
dark:hover:bg-gray-700 dark:hover:text-white transition duration-75 rounded-lg group" @click="open = !open"
...
dark:hover:bg-gray-700 dark:hover:text-white 
{{ request()->routeIs('administrator.overview') ? 'bg-gray-300 text-black dark:bg-gray-700 dark:text-white text-sm' : 'text-sm' }} pl-11 transition duration-75 rounded-lg group">
                                Unified View</a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('administrator.active') }}"
                                class="flex items-center w-full p-2 text-gray-500 dark:text-gray-500 hover:bg-gray-300 hover:text-black 
dark:hover:bg-gray-700 dark:hover:text-white 
{{ request()->routeIs('administrator.active') ? 'bg-gray-300 text-black dark:bg-gray-700 dark:text-white text-sm' : 'text-sm' }} pl-11 transition duration-75 rounded-lg group">
                        ...
                        <li>
                            <a href="{{ route('administrator.pending') }}"
                                class="flex items-center w-full p-2 text-gray-500 dark:text-gray-500 hover:bg-gray-300 hover:text-black 
dark:hover:bg-gray-700 dark:hover:text-white 
{{ request()->routeIs('administrator.pending') ? 'bg-gray-300 text-black dark:bg-gray-700 dark:text-white text-sm' : 'text-sm' }} pl-11 transition duration-75 rounded-lg group">
                        ...
                        <li>
                            <a href="{{ route('administrator.suspended') }}"
                                class="flex items-center w-full p-2 text-gray-500 dark:text-gray-500 hover:bg-gray-300 hover:text-black 
dark:hover:bg-gray-700 dark:hover:text-white 
{{ request()->routeIs('administrator.suspended') ? 'bg-gray-300 text-black dark:bg-gray-700 dark:text-white text-sm' : 'text-sm' }} pl-11 transition duration-75 rounded-lg group">
                    ...
                    <ul style="display:none;" x-show="open" x-transition class="py-2 space-y-2">
                        <li>
                            <a href="{{ route('administrator.tickets') }}"
                                class="flex items-center w-full p-2 text-gray-500 dark:text-gray-500 hover:bg-gray-300 hover:text-black 
dark:hover:bg-gray-700 dark:hover:text-white 
{{ request()->routeIs('administrator.tickets') ? 'bg-gray-300 text-black dark:bg-gray-700 dark:text-white text-sm' : 'text-sm' }} pl-11 transition duration-75 rounded-lg group">
                                Ticket Overview</a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('administrator.scan') }}"
                                class="flex items-center w-full p-2 text-gray-500 dark:text-gray-500 hover:bg-gray-300 hover:text-black 
dark:hover:bg-gray-700 dark:hover:text-white 
{{ request()->routeIs('administrator.scan') ? 'bg-gray-300 text-black dark:bg-gray-700 dark:text-white text-sm' : 'text-sm' }} pl-11 transition duration-75 rounded-lg group">
                                Ticket Scanner</a>
                        </li>
                    </ul>
                </li>
