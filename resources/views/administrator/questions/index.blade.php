...
<x-dash-layout title="Events">
    <section x-data="{ createmodal: false ,viewmodal:false, Editmodal:false}">
        <div class="mx-1 md:mx-3 lg:mx-5 rounded-lg shadow-sm p-6  bg-white dark:bg-peak_1">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="ml-auto flex items-center gap-2 ">
                        <button @click="createmodal = true"
                            class="hover:bg-green-400 focus:bg-green-500 inline-flex items-center justify-center text-sm font-medium border dark:border-white/10 rounded-md px-3 h-8 gap-1">
