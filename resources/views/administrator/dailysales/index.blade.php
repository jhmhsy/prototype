...
<x-dash-layout>
    ...
    <div class="bg-white dark:bg-peak_2 rounded-lg shadow-md">
        ...
        <div class="p-6">
            <div class="bg-white dark:bg-peak_2 p-6 rounded-lg space-y-6 mx-auto">
                ...
                <div class="border-b mb-2 border-gray-200 dark:border-gray-700 pb-4">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-black dark:text-white font-semibold">{{ $serviceCounts['1month'] }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-black dark:text-white font-semibold">{{ $serviceCounts['3month'] }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600 dark:text-white/50">6 Months</span>
                            <span class="text-black dark:text-white font-semibold">{{ $serviceCounts['6month'] }}</span>
                        </div>
                        <div class="flex justify-between items-center">
