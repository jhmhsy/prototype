...
<div>
    ...
    function applyDarkModePreference() {
        let e = localStorage.getItem("dark-mode"),
            t = "true" === e;
        document.documentElement.classList.toggle("dark", t), document.getElementById("toggleDarkLightMode").checked = t
    }
    document.getElementById("toggleDarkLightMode").addEventListener("change", function() {
        this.checked ? (document.documentElement.classList.add("dark"), localStorage.setItem("dark-mode", !0)) :
            (document.documentElement.classList.remove("dark"), localStorage.setItem("dark-mode", !1))
