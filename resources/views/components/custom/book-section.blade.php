<div class="max-w-xl mx-auto p-6 sm:p-8 md:p-10 bg-background rounded-lg shadow-lg">
    <div class="space-y-4">
        <div class="text-center">
            <h2 class="text-2xl font-bold tracking-tight">Reserve Your Private Gym Room</h2>
            <p class="text-muted-foreground">Book your preferred room type and duration.</p>
        </div>
