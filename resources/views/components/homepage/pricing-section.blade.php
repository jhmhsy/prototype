<div class="relative flex justify-center py-10 md:py-12 lg:py-20 dark:text-shade_9 ">
    <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-12 max-w-6xl w-full px-4 md:px-6 lg:px-8">
        <div class="flip-card relative md:col-span-1 transition-transform duration-300">
            <div class="flip-card-inner bg-primary rounded-lg shade-xl border border-black/30">
                <div class="flip-card-back absolute px-5 py-2 md:py-3 md:px-6 lg:py-4 lg:px-7">
                    ...
                    <button
                        class="py-2 w-full border bg-black rounded border-white text-white hover:bg-main transition-colors duration-300">Sign Up
                        Now</button>
                </div>
        ...
        <div class="flip-card relative md:col-span-1 transition-transform duration-300">
            <div
                ...
                <div class="flip-card-back absolute px-5 py-2 md:py-3 md:px-6 lg:py-4 lg:px-7 text-white">
                    ...
                    <ul class="space-y-1 mb-3">
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 mr-2 text-white">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg>
                    ...
                    <button
                        class="py-2 w-full border rounded border-white text-white hover:bg-white hover:text-blue-500 transition-colors duration-300">Sign Up
                        Now</button>
                </div>
                <div class="flip-card-front px-5 py-2 md:p-8 lg:p-10 text-white">
                    ...
                    <div class="flex items-baseline mb-6">
                        <span class="text-4xl md:text-5xl font-bold">₱100</span>
                        <span class="text-white opacity-75 ml-2">/1 day</span>
                    </div>
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        ...
        <div class="flip-card relative md:col-span-1 transition-transform duration-300">
            <div
                ...
                <div
                    class="flip-card-back absolute px-5 py-2 md:py-3 md:px-6 lg:py-4 lg:px-7 text-white ">
