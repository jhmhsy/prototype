        ...
        <div class="flip-card relative md:col-span-1 transition-transform duration-300">
            <div
                ...
                <div class="flip-card-back absolute px-5 py-2 md:py-3 md:px-6 lg:py-4 lg:px-7 text-white">
                    ...
                    <ul class="space-y-1 mb-3">
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="w-5 h-5 mr-2 text-white">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg>
                    ...
                    <button
                        class="py-2 w-full border rounded border-white text-white hover:bg-white hover:text-blue-500 transition-colors duration-300">Sign
                        Up
                        Now</button>
                </div>
