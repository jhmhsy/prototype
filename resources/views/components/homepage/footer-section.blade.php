<footer class="">
    ...
    <div class="container max-w-full px-4 pt-3 pb-4 mx-auto text-sm dark:bg-black dark:text-gray-300 sm:pt-5 md:pt-7">
        <div class="gap-8 mx-auto lg:flex lg:justify-between md:grid md:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3">

            <!-- Danao Gym Section -->
            <div class="mx-auto space-y-4 text-center lg:text-left">
                ...
                <form class="flex justify-center gap-2 lg:justify-start">
            ...
            <div class="grid grid-cols-3 gap-8 mx-auto text-center lg:text-left">
                <div>
                    <h3 class="mb-2 font-semibold text-md">Contact Us</h3>
                ...
                <!-- Quick Links Section -->
                <div>
                    <h3 class="mb-2 font-semibold text-md">Quick Links</h3>
                ...
                <div>
                    ...
                    <a href="#" class="flex items-center justify-center lg:justify-start group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="text-gray-400 bi bi-facebook group-hover:text-gray-100" viewBox="0 0 16 16">
                            <path
                    ...
                    <!-- Instagram -->
                    <a href="#" class="flex items-center justify-center mt-2 lg:justify-start group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="text-gray-400 bi bi-instagram group-hover:text-gray-100" viewBox="0 0 16 16">
                            <path
                    ...
                    <a href="#" class="flex items-center justify-center mt-2 lg:justify-start group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="text-gray-400 bi bi-twitter group-hover:text-gray-100" viewBox="0 0 16 16">
                            <path
        ...
        <p class="text-xs text-center text-gray-400">© {{ now()->year }} Danao Gym. All rights reserved.</p>
    </div>
