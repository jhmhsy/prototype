<div class=" items-center w-full py-12 md:py-24 lg:py-32 text-center relative">
    <div class=" grid items-center justify-center gap-4 px-4 text-center md:px-6 m-auto">
        <section
            ...
            <div
                class="w-full mt-40 grid grid-cols-2 items-center justify-center px-4 sm:px-15 py-10 sm:py-0 space-y-3">
                ...
                <section
                    ...
                    <div class="grid grid-cols-2 gap-5 w-[70%] mt-20">
                        <div class="w-full  flex flex-col p-5">
                            ...
                            <h3 class=" text-left">eque porro quisquam est qui dolorem ipsum quia dolor sit amet,
                                consectetur,
                                adipisci
                                velit.</h3>
                        ...
                        <div class="w-full flex items-center justify-center">
                            ...
                            <div class="w-full flex items-center justify-center">
                                ...
                                <div class="w-[70%] h-[356px] border border-white relative overflow-visible">
                                    <img src="/images/public/person_1.jpg" alt="Person 1"
