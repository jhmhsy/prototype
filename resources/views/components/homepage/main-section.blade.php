<div class="flex flex-col min-h-screen">
    ...
    <section class="flex items-center justify-center h-screen bg-cover bg-center"
        style="background-image: url(&quot;/images/public/background-2.jpg&quot;);">
        <div class="backdrop-blur-sm text-center text-white bg-black bg-opacity-50 p-8 rounded-md">
            ...
            <div class="container px-4 md:px-6 m-auto">
                <div class="mx-auto grid max-w-5xl gap-6 pt-10 pb-6 lg:grid-cols-3 lg:gap-12">
                    <div
                        ...
                        <h3 class="text-xl font-bold dark:text-tint_6">Easy
                            Booking</h3>
                    ...
                    <div
                        ...
                        <h3 class="text-xl font-bold dark:text-tint_6">Class
                            Schedules</h3>
                    ...
                    <div
                        ...
                        <h3 class="text-xl font-bold dark:text-tint_6">Member
                            Management</h3>
    ...
    <section class="flex flex-col md:flex-row items-center justify-center p-8 bg-black text-textwhite">

        <div class="w-full md:w-1/2 p-4">
            <img src="/images/public/background-1.jpg" alt="Gym" class="w-full h-auto rounded-md" alt="User Avatar" />
        </div>

        <div class="w-full md:w-1/2 p-4 space-y-8">

            <button class=" text-left w-full hover:border-l-4 p-4">
                <h2 class="text-5xl font-bold">Personal Training</h2>
                <p class="text-2xl">Get personalized training sessions with our expert trainers.</p>
            </button>

            <button class=" text-left w-full hover:border-l-4 p-4">
                <h2 class="text-5xl font-bold">Group Classes</h2>
                <p class="text-2xl">Join our group classes and stay motivated with others.</p>
            </button>



            <button class=" text-left w-full hover:border-l-4 p-4">
                <h2 class="text-5xl font-bold">State-of-the-Art Equipment</h2>
                <p class="text-2xl">Access the latest and best equipment for your workouts.</p>
            </button>
