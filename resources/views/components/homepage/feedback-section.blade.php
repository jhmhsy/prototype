            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1 space-y-2">
                    ...
                    <p class="text-muted-foreground">
                        I had trouble with the reservation system; it crashed when I tried to book a class, which was
                        frustrating
                    </p>
        ...
        <div class="bg-background rounded-lg border dark:border-darkgray p-6">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1 space-y-2">
                    ...
                    <p class="text-muted-foreground">
                        Purchasing tickets was seamless! I secured my spot in just a few clicks—great experience!
                    </p>
                    <div class="flex items-center gap-2">
                        <button
                            class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 w-10">
        ...
        <div class="bg-background rounded-lg border dark:border-darkgray p-6">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1 space-y-2">
                    ...
                    <p class="text-muted-foreground">
                        Booking workouts is a breeze! The reminders keep me on track with my fitness goals!
                    </p>
                    <div class="flex items-center gap-2">
                        <button
                            class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 w-10">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1 space-y-2">
                        ...
                        <div class="flex flex-row">
                            ...
                            <textarea id="comment" name="comment" x-data
                                        ...
                                        <div class="flex space-x-2" x-data="{ selectedRating: 0 }">
                                            ...
                                            <label class="flex items-center">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    class="w-5 h-5 cursor-pointer transition-colors duration-250 ease-in-out hover:text-complementary"
                                                    :class="(selectedRating >= 1) ? 'text-complementary' : 'text-gray-400'">
                                                    <polygon
                                            ...
                                            <label class="flex items-center">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    class="w-5 h-5 cursor-pointer transition-colors duration-250 ease-in-out hover:text-complementary"
                                                    :class="(selectedRating >= 2) ? 'text-complementary' : 'text-gray-400'">
                                                    <polygon
                                                        points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2">
                                                    </polygon>
                                                </svg>
                                            ...
                                            <label class="flex items-center">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    class="w-5 h-5 cursor-pointer transition-colors duration-250 ease-in-out hover:text-complementary"
                                                    :class="(selectedRating >= 3) ? 'text-complementary' : 'text-gray-400'">
                                                    <polygon
                                                        points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2">
                                                    </polygon>
                                                </svg>
                                            ...
                                            <label class="flex items-center">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    class="w-5 h-5 cursor-pointer transition-colors duration-250 ease-in-out hover:text-complementary"
                                                    :class="(selectedRating >= 4) ? 'text-complementary' : 'text-gray-400'">
                                                    <polygon
                                                        points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2">
                                                    </polygon>
                                                </svg>
                                            ...
                                            <label class="flex items-center">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    class="w-5 h-5 cursor-pointer transition-colors duration-250 ease-in-out hover:text-complementary"
                                                    :class="(selectedRating >= 5) ? 'text-complementary' : 'text-gray-400'">
                                                    <polygon
                                                        points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2">
                                                    </polygon>
                                                </svg>
