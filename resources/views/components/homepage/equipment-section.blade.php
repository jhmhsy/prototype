        ...
        <div
            ...
            <div
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="w-10 h-10 mb-4 group-hover:text-main text-shade_9 ">
                    <path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z" class=" transition-colors duration-300"></path>
                </svg>
...
<div
    ...
    <section class="px-5 sm:px-6 md:px-8 mb-12">
        ...
        <div class="grid max-w-6xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10">
            <div
                ...
                <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Weights</h3>
                <p class="text-gray-600 dark:text-gray-300">Variety of dumbbells and barbells for strength training.</p>
            </div>
            <div
                class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl p-6 flex flex-col items-center text-center transition-all duration-300 ease-in-out transform hover:-translate-y-2">
                ...
                <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Cardio Equipment</h3>
                <p class="text-gray-600 dark:text-gray-300">Treadmills, ellipticals, and stationary bikes for cardio.
                </p>
            </div>
            <div
                class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl p-6 flex flex-col items-center text-center transition-all duration-300 ease-in-out transform hover:-translate-y-2">
                ...
                <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Stretching Area</h3>
                <p class="text-gray-600 dark:text-gray-300">Dedicated space for yoga, Pilates, and other stretching.</p>
            </div>
            <div
                class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl p-6 flex flex-col items-center text-center transition-all duration-300 ease-in-out transform hover:-translate-y-2">
                ...
                <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Rowing Machines</h3>
                <p class="text-gray-600 dark:text-gray-300">High-intensity rowing machines for a full-body workout.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="px-5 sm:px-6 md:px-8">
        ...
        <div class="grid max-w-6xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10">
            <div
                ...
                <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Locker Rooms</h3>
                <p class="text-gray-600 dark:text-gray-300">Spacious locker rooms with showers and changing areas.</p>
            </div>
            <div
                class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl p-6 flex flex-col items-center text-center transition-all duration-300 ease-in-out transform hover:-translate-y-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Juice Bar</h3>
                <p class="text-gray-600 dark:text-gray-300">Refuel with a variety of healthy smoothies and juices.</p>
            </div>
            <div
                class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl p-6 flex flex-col items-center text-center transition-all duration-300 ease-in-out transform hover:-translate-y-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mb-4 text-pink-500" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M3.5 21L14 3M20.5 21L10 3M15.5 21L12 15l-3.5 6M2 21h20" />
                </svg>
                <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Towel Service</h3>
                <p class="text-gray-600 dark:text-gray-300">Complimentary towel service for your workout needs.</p>
            </div>
            <div
                class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl p-6 flex flex-col items-center text-center transition-all duration-300 ease-in-out transform hover:-translate-y-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mb-4 text-teal-500" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 20h.01M2 8.82a15 15 0 0 1 20 0M5 12.859a10 10 0 0 1 14 0M8.5 16.429a5 5 0 0 1 7 0" />
                </svg>
                <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Free WiFi</h3>
                <p class="text-gray-600 dark:text-gray-300">Stay connected with high-speed wireless internet access.
                </p>
            </div>
        </div>
    </section>
