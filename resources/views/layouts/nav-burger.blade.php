...
<burger-admin x-data="{ open: false }" @click.outside="open = false" id="burger-admin">
    ...
    <aside x-show="open" x-transition aria-label="Sidenav" class=" sm:hidden">
        <div class="fixed z-20  overflow-y-none py-3 left-0 px-5 top-0 h-full bg-white border-r border-gray-200 dark:bg-gray-800 
...
<!-- Burger Design for Home/Landing Page-->
@if($showburgerHome ?? false)
<burger-home x-data="{ open: false }" @cl ick.outside="open = false" id="burger-home">
    <button @click="open = ! open" data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar"
        aria-controls="default-sidebar" type="button"
        class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
        <span class="sr-only">Open sidebar</span>
    ...
    <aside x-show="open" x-transition aria-label="Sidenav" class=" sm:hidden" id="burger-home">
        <div class="fixed z-20  overflow-y-none py-3 left-0 px-5 top-0 h-full bg-white border-r border-gray-200 dark:bg-gray-800 
            dark:border-gray-700">
