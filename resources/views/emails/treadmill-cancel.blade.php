...
<head>
    ...
    <title>Treadmill Cancelation - Pending</title>
    <!--[if mso]>
    <style type="text/css">
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <tr>
                        <td style="padding: 40px; text-align: center;">
                            <h1 style="color: #2c3e50; margin-bottom: 30px; font-size: 24px;">Treadmill Cancelation -
                                Pending
                            </h1>
                            <p style="margin-bottom: 15px;">A treadmill has been marked for
                                <strong>cancellation</strong> and is awaiting admin approval.
                            </p>

                            <p style="margin-bottom: 15px;">Below is the details of Canceled Service:
                            </p>
                                        ...
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td
                                                    style="color: #495057;  text-align: left; font-weight: 600; width: 50%;">
                                                    Amount</td>
                                                <td style="color: #212529; text-align: right;">{{ $treadmill->amount }}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td
                                                    style="color: #495057;  text-align: left; font-weight: 600; width: 50%;">
                                                    Status</td>
                                                <td style="color: #212529; text-align: right;">{{ $treadmill->status }}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
