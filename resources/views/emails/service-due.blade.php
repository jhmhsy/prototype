                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <tr>
                        <td style="padding: 40px; text-align: center;">
                            <h1 style="color: #2c3e50; margin-bottom: 30px; font-size: 24px;">Service Due Reminder
                            </h1>

                            <p style="margin-bottom: 15px;">Dear {{ $member->name }},</p>

                            <p style="margin-bottom: 15px;">This is a reminder that you have an upcoming service due:
                            </p>
                                        ...
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td
                                                    style="color: #495057;  text-align: left; font-weight: 600; width: 50%;">
                                                    Due Date</td>
                                                <td style="color: #212529; text-align: right;">{{ $service->due_date }}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="margin-bottom: 15px;">Please take necessary action before the due date.</p>
