                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <tr>
                        <td style="padding: 40px; text-align: center;">
                            <h1 style="color: #2c3e50; margin-bottom: 30px; font-size: 24px;">Treadmill Due Reminder
                            </h1>

                            <p style="margin-bottom: 15px;">Dear {{ $member->name }},</p>

                            <p style="margin-bottom: 15px;">This is a reminder that your treadmill subscription is due
                                soon:
                            </p>
                                        ...
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td
                                                    style="color: #495057;  text-align: left; font-weight: 600; width: 50%;">
                                                    Month</td>
                                                <td style="color: #212529; text-align: right;">{{ $treadmill->month }}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="margin-bottom: 15px;">Please process the renewal before the due date to avoid any
                                interruption in your treadmill access.</p>

                            <p style="color: #6c757d; text-align: center; font-size: 14px;">TThank you for choosing our
                                services.
                            </p>
                        </td>
                    </tr>
