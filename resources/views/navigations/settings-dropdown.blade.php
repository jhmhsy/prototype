...
<div class="flex flex-col select-none">
    ...
    @can('is-admin')
    <x-forms.responsive-nav-link :href="route('administrator.overview')" class="hover:bg-green-400">
        {{ __('Dashboard') }}
    </x-forms.responsive-nav-link>
    @endcan
...
<div class=" sm:flex sm:items-center select-none cursor-pointer ">
    <x-custom.dropdown align="right" width="56">
        ...
        <x-slot name="content" transparent>
            <div
                class=" bg-white dark:bg-shade_9 dark:text-tint_1 text-shade_9 shadow-lg border-white/10 border border-t-0 p-1">
