    ...
    @auth
        @if ($column ?? false)
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <x-forms.dropdown-link :href="route('logout')" class="hover:bg-red-500"
            ...
            <div class=" sm:flex sm:items-center">
                <x-custom.dropdown align="right" width="56">
                    ...
                    <x-slot name="content" transparent>
                        <div
                            class=" bg-white dark:bg-darkmode_dark text-white shadow-lg border-white/10 border border-t-0">
                            <x-forms.dropdown-link :href="route('profile.edit')"
