<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-custom.error :errors="$errors->updatePassword->get('current_password')" class="mt-2" />
        </div>

        <div>
            <x-forms.input-label for="update_password_password" :value="__('New Password')" />
            <x-forms.text-input id="update_password_password" name="password" type="password" class="mt-1 block w-full"
                autocomplete="new-password" />
            <x-custom.error :errors="$errors->updatePassword->get('password')" class="mt-2" />
        </div>
        ...
        <div>
            ...
            <x-custom.error :errors="$errors->updatePassword->get('password_confirmation')" class="mt-2" />
        </div>
