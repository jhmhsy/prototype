<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="p-4 sm:p-8 bg-white dark:bg-peak_2 text-textblack dark:text-textwhite shadow sm:rounded-lg">
            <!-- Dropdown menu for dark mode -->
            <label for="darkmode-toggle" class="block text-sm font-medium ">Dark
                Mode</label>
            <select id="darkmode-toggle"
                class="mt-1 block w-full py-2 px-3 border border-gray-500 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-white dark:bg-peak_1">
