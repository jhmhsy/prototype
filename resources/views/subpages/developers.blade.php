        ...
        <main class="pt-15 flex flex-1 items-center justify-center px-8">
            ...
            <div class="max-w-7xl w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 p-8">
                ...
                <div class="transform transition-all duration-300 hover:scale-105 hover:z-10">
                    <div class="bg-peak-3 rounded-xl overflow-hidden shadow-2xl border border-peak-4 hover:border-peak-2 transition-colors">
                ...
                <div class="transform transition-all duration-300 hover:scale-105 hover:z-10">
                    <div class="bg-peak-3 rounded-xl overflow-hidden shadow-2xl border border-peak-4 hover:border-peak-2 transition-colors">
                        <div class="relative aspect-[3/4]">
                            <img src={{ asset("/images/devs/henry.png") }} alt="Henry" class="h-full w-full object-cover">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                        </div>
                        <div class="p-4 text-center space-y-1">
                ...
                <div class="transform transition-all duration-300 hover:scale-105 hover:z-10">
                    <div class="bg-peak-3 rounded-xl overflow-hidden shadow-2xl border border-peak-4 hover:border-peak-2 transition-colors">
                        <div class="relative aspect-[3/4]">
                            <img src={{ asset("/images/devs/jason.png") }} alt="Jason" class="h-full w-full object-cover">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                        </div>
                        <div class="p-4 text-center space-y-1">
