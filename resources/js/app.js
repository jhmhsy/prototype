...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.action-dropdown').forEach((dropdown) => {
    ...
    button.addEventListener('click', (e) => {
      ...
      document.querySelectorAll('.action-dropdown-menu.show').forEach((m) => m !== menu && m.classList.remove('show'));
      ...
      if (menu.classList.contains('show')) {
        ...
        menu.style.left = spaceRight > menuRect.width ? `${rect.right}px` : `${rect.left - menuRect.width}px`;
...
// HOMEPAGE:  Redirect the Join us / Email to register
